        ...
        <div class="row">
            ...
            <div class="col-xs-12 border-bottom-ddd">
                <ul class="list-unstyled integral-list pb-15" style="width: 280px;">
                    ...
                    -->
                    <li class="text-center active"><a href="/Admin/Svn/index" style="width: 130px;">当月全部明细</a></li>
                    <li class="text-center"><a href="/Admin/Svn/count" style="width: 130px;">统计</a></li>
                </ul>
            ...
            <div class="col-xs-12 pt-15">
                <div class="pull-right ml-10 mb-5">
                    <a class="btn btn-green" href="/Admin/Svn/exportExcel">导出明细</a>
                </div>
...
$(function(){
    ...
    $("#change-date").datetimepicker({
        ...
        window.location.href="/Admin/Svn/index/date/"+$(this).val();
    });
